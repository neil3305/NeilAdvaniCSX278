...
function addBondMovies(){
    client.bulk({
        body: [
            {index: {_index: "movies", _type: "bond_movies", _id: "2" }},
            from_russia_with_love,
            {index: {_index: "movies", _type: "bond_movies", _id: "3" }},
            goldfinger,
            {index: {_index: "movies", _type: "bond_movies", _id: "4" }},
            thunderball,
            {index: {_index: "movies", _type: "bond_movies", _id: "5" }},
            casino_royale,
            {index: {_index: "movies", _type: "bond_movies", _id: "6" }},
            you_only_live_twice,
            {index: {_index: "movies", _type: "bond_movies", _id: "7" }},
            on_her_majestys_secret_service,
            {index: {_index: "movies", _type: "bond_movies", _id: "8" }},
            diamonds_are_forever,
            {index: {_index: "movies", _type: "bond_movies", _id: "9" }},
            live_and_let_die,
            {index: {_index: "movies", _type: "bond_movies", _id: "10" }},
            the_man_with_the_golden_gun,
            {index: {_index: "movies", _type: "bond_movies", _id: "11" }},
            the_spy_who_loved_me,
            {index: {_index: "movies", _type: "bond_movies", _id: "12" }},
            moonraker,
            {index: {_index: "movies", _type: "bond_movies", _id: "13" }},
            for_your_eyes_only,
            {index: {_index: "movies", _type: "bond_movies", _id: "14" }},
            octopussy,
            {index: {_index: "movies", _type: "bond_movies", _id: "15" }},
            never_say_never_again,
            {index: {_index: "movies", _type: "bond_movies", _id: "16" }},
            a_view_to_a_kill,
            {index: {_index: "movies", _type: "bond_movies", _id: "17" }},
            the_living_daylights,
            {index: {_index: "movies", _type: "bond_movies", _id: "18" }},
            licence_to_kill,
            {index: {_index: "movies", _type: "bond_movies", _id: "19" }},
            goldeneye,
            {index: {_index: "movies", _type: "bond_movies", _id: "20" }},
            tomorrow_never_dies,
            {index: {_index: "movies", _type: "bond_movies", _id: "21" }},
            the_world_is_not_enough,
            {index: {_index: "movies", _type: "bond_movies", _id: "22" }},
            die_another_day,
            {index: {_index: "movies", _type: "bond_movies", _id: "23" }},
            casino_royale2,
            {index: {_index: "movies", _type: "bond_movies", _id: "24" }},
            quantum_of_solace,
            {index: {_index: "movies", _type: "bond_movies", _id: "25" }},
            skyfall,
            {index: {_index: "movies", _type: "bond_movies", _id: "26" }},
            spectre
        ]
    });
}
